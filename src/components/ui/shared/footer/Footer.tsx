...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 py-12 text-white">
      <div className="w-full md:flex justify-between max-w-7xl px-4 lg:px-0 mx-auto py-10">
        <div>
      ...
      <div className="max-w-7xl mx-auto border-t border-gray-700 px-4 lg:px-0 pt-4">

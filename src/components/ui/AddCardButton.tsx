...
const AddCardButton = ({ name }: TButtonProps) => {
  return (
    <div>
      <button className="relative bg-red-500 text-white py-3 px-6 rounded-full flex items-center justify-center overflow-hidden transition-all duration-500 hover:text-red-500">
